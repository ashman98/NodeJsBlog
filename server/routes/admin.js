...
*/
router.get('/add-post', adminAuthMiddleware, async (req, res) => {
  try {
    const locals = {
      title: 'Add Post',
      description: 'Simple Blog created with NodeJs, Express & MongoDb.'
 ...
 * Admin - Create New Post
*/
router.post('/add-post', adminAuthMiddleware, async (req, res) => {
  try {
    try {
 ...
 * Admin - Create New Post
*/
router.get('/edit-post/:id', adminAuthMiddleware, async (req, res) => {
  try {
 ...
 * Admin - Create New Post
*/
router.put('/edit-post/:id', adminAuthMiddleware, async (req, res) => {
  try {
 ...
 * Admin - Delete Post
*/
router.delete('/delete-post/:id', adminAuthMiddleware, async (req, res) => {
